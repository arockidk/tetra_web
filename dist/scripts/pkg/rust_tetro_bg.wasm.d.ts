...
export function __wbg_queuenode_free(a: number, b: number): void;
...
export function __wbg_queue_free(a: number, b: number): void;
...
export function __wbg_choose_free(a: number, b: number): void;
export function __wbg_get_choose_count(a: number): number;
export function __wbg_set_choose_count(a: number, b: number): void;
export function choose_new(a: number, b: number, c: number): number;
export function choose_size(a: number): number;
export function choose_getQueues(a: number, b: number): void;
export function choose_from_string(a: number, b: number): number;
export function choose_sort(a: number): void;
...
export function __wbg_clearstruct_free(a: number, b: number): void;
...
export function __wbg_tetboard_free(a: number, b: number): void;
...
export function tetboard_noColorString(a: number, b: number): void;
export function __wbg_u64_board_free(a: number, b: number): void;
export function __wbg_tetpage_free(a: number, b: number): void;
...
export function __wbg_tetfumen_free(a: number, b: number): void;
...
export function tetpage_createBlankPiece(a: number): void;
...
export function tetpage_fromFumenPage(a: number): number;
export function tetfumen_new(): number;
export function tetfumen_load(a: number, b: number): number;
export function tetfumen_loadSlice(a: number, b: number): number;
export function tetfumen_len(a: number): number;
...
export function __wbg_tetpiece_free(a: number, b: number): void;
...
export function tetpiece_minoAbove(a: number, b: number): number;
export function __wbg_field_free(a: number, b: number): void;
...
export function field_fromBoard(a: number): number;
...
export function __wbg_action_free(a: number, b: number): void;
...
export function __wbg_fumen_free(a: number, b: number): void;
...
export function __wbg_piece_free(a: number, b: number): void;
...
export function __wbg_decodefumenerror_free(a: number, b: number): void;
